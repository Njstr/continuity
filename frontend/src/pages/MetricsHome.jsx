    ...
    >
      ...
      <div
        style={{
          ...
          // While locked, the grid still renders (so the blur has real
          // content to blur) but is capped and clipped to the same box
          // the lock overlay covers — otherwise the grid's natural height
          // can exceed one screen and push the overlay's centering target
          // below the fold, off-screen, even though it's technically
          // "there." That was the actual lock-appears-broken bug.
          ...(unlocked ? {} : { maxHeight: "100%", overflow: "hidden" }),
        }}
      >
      ...
      {!unlocked && (
        <div
          style={{
            position: "absolute", top: 90, left: 16, right: 16, bottom: 16, zIndex: 5,
