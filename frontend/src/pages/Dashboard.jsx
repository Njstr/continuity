      ...
      <Section title="PREDICTION ACCURACY">
        {avgErr !== null ? (
          <p style={styles.missionText}>
            Across {completedDecisions.length} completed simulation{completedDecisions.length === 1 ? "" : "s"}, average prediction error is <b style={{ color: C.accent }}>{formatErrorPct(avgErr)}</b>.
          </p>
        ) : (
