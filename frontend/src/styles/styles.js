...
export const styles = {
  ...
  chatScroll: { flex: 1, overflowY: "auto", padding: "16px 0", display: "flex", flexDirection: "column" },
  chatContentCol: { display: "flex", flexDirection: "column", gap: 10, flex: 1 },
  ...
  chatInputBar: { borderTop: `1px solid ${C.border}` },
  chatInputRow: { display: "flex", gap: 8, padding: 12 },
