...
export const api = {
  ...
  mission: (profile, missions) => request("/api/mission", { body: { profile, missions } }),
  ...
  chat: (profile, missions, feedback, history) => request("/api/chat", { body: { profile, missions, feedback, history } }),
  weeklyReview: (profile, answers, missions) => request("/api/weekly-review", { body: { profile, answers, missions } }),
