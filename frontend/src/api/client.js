...
export const api = {
  ...
  chat: (profile, missions, feedback, history, mode, scenario) => request("/api/chat", { body: { profile, missions, feedback, history, mode, scenario } }),
  ...
  founderAdvisor: (profile, businessState, metrics, missions, decisions, healthLatest, prediction) =>
    request("/api/advisor", { body: { profile, businessState, metrics, missions, decisions, healthLatest, prediction } }),
