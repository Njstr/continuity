...
// Auto-derives currency from country at onboarding so founders only pick
// one field, not two — currency/jurisdiction are needed for the app to
// actually function (money formatting, legal grounding), everything else
// about the business is learned through conversation instead.
...
// improve / related metrics) that powers the info-icon modal on the Metrics tab.
export const METRIC_GROUPS = [
  {
    key: "financial",
    label: "Financial",
    fields: [
      { key: "revenue", label: "Revenue", unit: "currency", priority: true, info: {
        ...
        influencedBy: ["Conversion Rate", "Total Customers", "CAC"], influences: ["Runway", "Net Profit"],
      } },
      { key: "grossProfit", label: "Gross Profit", unit: "currency", priority: true, info: {
        definition: "Revenue minus cost of goods/services sold (COGS) — before operating costs like salaries, rent, marketing.",
        why: "Shows whether the core product/service itself is economically viable, separate from how the business is run.",
        healthyRange: "70%+ gross margin is typical for pure software; lower is normal if there's a services or hardware component.",
        improve: "Reduce direct delivery costs (hosting, support, COGS) or raise prices — don't confuse this with cutting operating expenses.",
        influencedBy: ["Revenue", "Cost of goods sold"], influences: ["Operating Profit", "Net Profit"],
      } },
      { key: "operatingProfit", label: "Operating Profit", unit: "currency", priority: true, info: {
        definition: "Gross profit minus operating expenses (salaries, rent, marketing, tools) — before interest and tax.",
        why: "Tells you if the core business operations are profitable, independent of financing or tax structure.",
        healthyRange: "Negative is normal pre-scale; what matters is the trend improving as revenue grows.",
        improve: "Grow gross profit faster than operating expenses grow — don't let headcount outpace revenue.",
        influencedBy: ["Gross Profit", "Expenses"], influences: ["Net Profit"],
      } },
      { key: "profit", label: "Net Profit", unit: "currency", priority: true, info: {
        definition: "The true bottom line: revenue minus ALL expenses, including operating costs, interest, and tax.",
        why: "The final answer to \"does this business make money.\"",
        ...
        influencedBy: ["Operating Profit", "Interest", "Tax"], influences: ["Valuation", "Founder Satisfaction"],
      } },
      { key: "expenses", label: "Total Expenses", unit: "currency", priority: true, info: {
      ...
      { key: "grossExpenses", label: "Gross Expenses", unit: "currency", priority: true, info: {
        definition: "Total expenses before any deductions — reimbursements, discounts, or write-offs not yet netted out.",
        why: "The raw spend number, useful for spotting cost creep before it's masked by adjustments.",
        healthyRange: "Track alongside net expenses; a growing gap between the two is worth investigating.",
        improve: "Same levers as total expenses — audit recurring costs, delay non-critical spend.",
        influencedBy: ["Team Size", "Marketing Spend"], influences: ["Net Expenses", "Burn Rate"],
      } },
      { key: "netExpenses", label: "Net Expenses", unit: "currency", priority: true, info: {
        definition: "Expenses after deducting refunds, reimbursements, or credits — what actually left the bank net.",
        why: "The more accurate number for real cash impact, versus gross expenses which can overstate true spend.",
        healthyRange: "Should track close to gross expenses; a large gap suggests heavy credits/reimbursements worth understanding.",
        improve: "Same levers as total expenses.",
        influencedBy: ["Gross Expenses", "Refunds/credits"], influences: ["Burn Rate", "Cash Balance"],
      } },
      ...
      { key: "burnRate", label: "Burn Rate", unit: "currency", priority: true, info: {
      ...
      { key: "cashBalance", label: "Cash Balance", unit: "currency", priority: true, info: {
        ...
        influencedBy: ["Equity Raised", "Net Profit"], influences: ["Runway"],
      } },
...
// Every metric starts as null (unknown) — never 0 — until a real
// document or founder confirmation supplies a value. See constants below
// for the info metadata that powers the Metrics tab's info-icon modal.
...
export const TERMS_BODY = [
  ...
  "The makers of this app may update its features, data handling, and behavior over time, and no warranty of accuracy, availability, or fitness for a particular purpose is made.",
];
...
export const FAQS = [
  ...
  },
  {
    ...
    a: "Your startup profile, metrics, and decision history are kept private to your account and used only to power your own predictions. They're never shown to other users or used to train shared models.",
  },
];
