...
export default function App() {
  ...
  // Applies AI-extracted financial values (only ever called after the
  // founder explicitly confirms them in the review modal — see
  // MetricsExtractionReview) and unlocks the Metrics page permanently the
  // first time any financial data is applied, whether the upload happened
  // in Chat or directly on the Metrics page.
