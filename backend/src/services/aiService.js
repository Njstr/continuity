...
${relevantChunks.length ? `\nWhen you use a company document above, end your reply with a short "Sources Used" line naming the document(s) by filename (e.g. "Sources Used: Employee_Handbook.pdf"). You do not have live web access from inside this chat — if the question needs current external information (laws, regulations, rates), say so plainly and suggest where to check, rather than presenting general training knowledge as current or inventing a web citation.` : ""}`;
