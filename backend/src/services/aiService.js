...
Output ONLY JSON:
{
  ...
  "responseText": "Your reply, ONLY if intent is QUESTION or OFF_TOPIC. For QUESTION: actually help them execute, don't just repeat the instructions back — e.g. if they ask 'who should I talk to', help them think through specific candidates or a concrete way to find some, the way a hands-on cofounder would, not a task description read aloud. For OFF_TOPIC, answer briefly if it's a real question, but keep it short and bring focus back naturally. Null if intent is STUCK or EVIDENCE.",
