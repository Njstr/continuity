...
const adminFeedbackPage = require("./routes/adminPage");
...
// Human-readable feedback viewer — public page shell, but shows nothing
// without the correct ADMIN_TOKEN entered client-side (see routes/adminPage.js).
app.get("/admin/feedback", adminFeedbackPage);
