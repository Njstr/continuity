...
router.post(
  ...
  asyncHandler(async (req, res) => {
    const { profile, missions, feedback, history, mode, scenario } = req.body;
    ...
    const reply = await aiService.chat(req.userId, { profile, missions, feedback, history, patterns, mode, scenario });
